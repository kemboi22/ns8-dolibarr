...
try:
    ...
    odom = {
        ...
        'schema': 'rfc2307',
        'location': 'internal',
        'base_dn': 'dc=dolibarr,dc=invalid',
        'bind_dn': 'cn=example,dc=dolibarr,dc=invalid',
...
with open(tmpfile, "w") as denv:
    print('DOLIBARR_LDAP_PORT=' + str(odom['port']), file=denv)
    print('DOLIBARR_LDAP_USER=' + odom['bind_dn'], file=denv)
    print('DOLIBARR_LDAP_HOST=' + odom['host'], file=denv)
    print('DOLIBARR_LDAP_PASS=' + odom['bind_password'], file=denv)
    print('DOLIBARR_LDAP_SCHEMA=' + odom['schema'], file=denv)
    print('DOLIBARR_LDAP_BASE=' + odom['base_dn'], file=denv)
